    ...
    <body>
        ...
        <nav id="nav">
            ...
            <div class="nav-body">
                <button type="button" class="btn nav-close">
                    <img src="/assets/images/ico_btn_close.png" alt="닫기">
                    <span class="sr-only">메뉴닫기</span>
                </button>
                <div class="gnb-menu">
                    <ul>
                        <li>
                            <a href="#">전시장 위치 안내<span></span></a>
                            <ul>
                        ...
                        <li>
                            <a href="#">贸 智易能展及区高端装备展区<span></span></a>
                            <ul>
                                <li><a href="#">3H</a></li>
                                <li><a href="#">4.1H</a></li>
                            </ul>
                        ...
                        <li>
                            <a href="#">医疗器械及医药保健展区<span></span></a>
                            <ul>
                                <li><a href="#">menu1</a></li>
                                <li><a href="#">menu2</a></li>
                                <li><a href="#">menu3</a></li>
        ...
        <main id="fullpage">
            ...
            <section class="section service-trade">
                <div class="container">
                    <div class="section-header">
                        <h2>服务贸易展区<small>(1A7-024)</small></h2>
                    </div>
                    <div class="section-content">
                        <nav class="trade-tab">
                            <ul>
                                <li class="active"><a href="#">服务贸易展区</a></li>
                                <li><a href="#">服务贸易</a></li>
                                <li><a href="#">贸 智易能展及区高端装备展区</a></li>
                                <li><a href="#">消费及电子家电展区•</a></li>
                                <li><a href="#">服装服饰及日用消费品展区</a></li>
                                <li><a href="#">医疗器械及医药保健展区</a></li>
                                <li><a href="#">食品及农产品展区</a></li>
                            </ul>
                        </nav>
